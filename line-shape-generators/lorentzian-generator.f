...
! My pateneted help protocol!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     + lorentzian(s) and the corresponding antisymmeterized pair"
         write (*,*)
     ...
     + the second."
         write (*,*)
         write (*,*) "Example:"
         write (*,*) "lorentzian-generator filename spacing hwhh"
         write (*,*)
         write (*,*) "Note: Data will be generated from 0 to the last
     + position-value +20"
      stop
      end if
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      open(14,FILE="lorentzian.dat",STATUS="replace")
      call cdgenerate
      open(15,FILE="anti-lorentzian.dat",STATUS="replace")
      call ordgenerate
