...
!      write (*,*) xsum, ysum, zsum, csum
      ...
      write (*,*) "Re-centering molecule........................."
      
      do i = 1, natoms
      cent(i,1) = cent(i,1) - xav
      cent(i,2) = cent(i,2) - yav
      cent(i,3) = cent(i,3) - zav
      end do
      ...
      write (*,*) "New center or charge is:"
      write (*,*) xav, yav, zav

      write (*,*) "(over)Writing new XYZ file centered.xyz............."
      open (21,file="centered.xyz",status="UNKNOWN",ERR=6005)
      write (21,*) natoms
      write (21,*) 
      do i = 1, natoms
      write (21,*) atoms(i,1), cent(i,1:3)
      end do
      close(21)
